        ...
        <section className="banner_aboutUs">
          <div className="Overlay_aboutUs">
            ...
            <p>
              ...
              know how scary it can be to lose your dog. I am hoping that
              through this site, the community can come together to help each
              other find their lost pets.
            </p>
            ...
            <p>
              ...
              to helping families reunite with their lost puppies. We all know
              how scary it can be to come home and find your dog missing. Take
              your first steps now by signing up and if this site was able to
